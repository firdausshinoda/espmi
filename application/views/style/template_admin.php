		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<a class="nav-link" href="<?= site_url('Admin/notification'); ?>">
					...
					<span class="badge badge-warning navbar-badge"><?= db_notif_konsul_unit(); ?></span>
				</a>
			</li>
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
					...
					<a href="<?= site_url('Admin/sign_out'); ?>" class="dropdown-item">
	...
	<aside class="main-sidebar elevation-4 sidebar-dark-primary">
		...
		<div class="sidebar">
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				...
				<div class="info">
					<a href="<?= site_url('Admin/profil'); ?>" class="d-block">
						<?= sess_get('nama'); ?>
					</a>
				</div>
			</div>
			...
			<nav class="mt-2">
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					<li class="nav-item">
						<a href="<?= site_url('Admin'); ?>" class="nav-link" id="i_dashboard">
					...
					<li class="nav-item has-treeview" id="treeview_dokspmi">
						...
						<ul class="nav nav-treeview">
							<li class="nav-item">
								<a href="<?= site_url('Admin/dokumen?type=standar-spmi'); ?>" class="nav-link" id="sub_dokspmi_standar">
							...
							<li class="nav-item has-treeview" id="sub_dokspmi_manual">
								...
								<ul class="nav-treeview" id="treeview_sub_dokspmi_manual">
									<li class="nav-item">
										<a href="<?= site_url('Admin/dokumen?type=manual-mutu-penetapan'); ?>" class="nav-link" id="sub_dokspmi_manual_penetapan">
											<i class="far fa-dot-circle nav-icon"></i>
											<p>Manual Penetapan</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?= site_url('Admin/dokumen?type=manual-mutu-pelaksanaan'); ?>" class="nav-link" id="sub_dokspmi_manual_pelaksanaan">
											<i class="far fa-dot-circle nav-icon"></i>
											<p>Manual Pelaksanaan</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?= site_url('Admin/dokumen?type=manual-mutu-evaluasi'); ?>" class="nav-link" id="sub_dokspmi_manual_evaluasi">
											<i class="far fa-dot-circle nav-icon"></i>
											<p>Manual Evaluasi</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?= site_url('Admin/dokumen?type=manual-mutu-pengendalian'); ?>" class="nav-link" id="sub_dokspmi_manual_pengendalian">
											<i class="far fa-dot-circle nav-icon"></i>
											<p>Manual Pengendalian</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?= site_url('Admin/dokumen?type=manual-mutu-peningkatan'); ?>" class="nav-link" id="sub_dokspmi_manual_peningkatan">
											<i class="far fa-dot-circle nav-icon"></i>
							...
							<li class="nav-item">
								<a href="<?= site_url('Admin/dokumen?type=formulir'); ?>" class="nav-link" id="sub_dokspmi_formulir">
									<i class="far fa-circle nav-icon"></i>
									<p>Formulir</p>
								</a>
							</li>
					...
					<li class="nav-item">
						<a href="<?= site_url('Admin/dokumen?type=kebijakan'); ?>" class="nav-link" id="i_kebijakan">
							<i class="nav-icon fas fa-book"></i>
							<p>Kebijakan</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= site_url('Admin/dokumen?type=dok-institusi'); ?>" class="nav-link" id="i_dokumen">
							<i class="nav-icon fas fa-book"></i>
							<p>Dokumen Institusi</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= site_url('Admin/konsultasi'); ?>" class="nav-link" id="i_konsultasi">
							<i class="nav-icon fas fa-comments"></i>
							<p>Konsultasi</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= site_url('Admin/nodok'); ?>" class="nav-link" id="i_nodok">
							<i class="nav-icon fas fa-book"></i>
							<p>Nomor Dokumen</p>
						</a>
					</li>
