			...
			<div class="col-sm-12 mt-3">
				<div class="card card-white">
					<div class="card-header">
						<h3 class="card-title"><b>Daftar Pengguna Unit</b></h3>
					</div>
					<div class="card-body">
								...
								<div class="row">
									<div class="col-sm-12 col-md-3">
										<div class="form-group">
											<label><small><b>Jenis Unit</b></small></label>
											<select class="form-control form-control-sm" id="jenis_unit" onchange="getData()">
...
<script type="text/javascript">
    ...
    $('#sub_laporan_list_user_unit').addClass("active");
    ...
    function cetak(str) {
        window.open("<?= base_url('Cetak/laporan_admin?type=');?>"+str+"&jenis_unit="+$('#jenis_unit').val(),"_blank ");
    }
</script>
