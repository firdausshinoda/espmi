			...
			<div class="col-sm-12 mt-3">
				<div class="card card-white">
					<div class="card-header">
						<h3 class="card-title"><b>Daftar Konsultasi</b></h3>
					</div>
					<div class="card-body">
...
<script type="text/javascript">
    ...
    $('#sub_laporan_list_konsultasi').addClass("active");
    ...
    function cetak(str) {
        window.open("<?= base_url('Cetak/laporan_konsultasi?type=');?>"+str+"&jenis_dokumen="+$('#jenis_dokumen').val(),"_blank ");
    }
</script>
