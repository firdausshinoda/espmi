					...
					<div class="card shadow">
						...
						<div class="card-body row">
							...
							<div class="form-group col-sm-12">
								...
								<select type="text" class="form-control form-control-sm select2" id="jenis_dokumen" name="jenis_dokumen" style="width: 100%;">
    ...
    $(function() {
		...
		$('#jenis_dokumen').select2({
			ajax: {
				...
				data: function (params) {return { search: params.term, page: params.page || 1, [csrfName]: csrfHash, type: "DOKUMEN INSTITUSI" };},
