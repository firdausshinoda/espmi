				...
				<form id="formValidate" class="formValidate">
					<div class="card shadow">
						<div class="card-header">
							<b>Tambah Dokumen Manual Mutu Pengendalian</b>
						</div>
						<div class="card-body">
							...
							<div class="form-group col-sm-12">
								...
								<input type="text" class="form-control form-control-sm" value="MANUAL MUTU PENGENDALIAN" disabled/>
								<input type="hidden" id="jenis_dokumen" name="jenis_dokumen" value="5"/>
							</div>
							<div class="col-sm-12">
								<div class="row">
									<div class="form-group col-sm-8">
										...
										<select class="form-control form-control-sm select2" id="kode_no" name="kode_no" style="width: 100%;">
											<option value="">--Silahkan Pilih Standar Terkait--</option>
										</select>
									</div>
									<div class="form-group col-sm-4">
										<label for="exampleInputEmail1"><small><b>Tambah Kode/Buat Baru Standar Terkait</b></small></label>
							...
							<div class="display_none col-sm-12" id="viewAddKode">
								<div class="row">
									<div class="form-group col-sm-8">
										<label for="exampleInputEmail1"><small><b>Kode Tambahan/Buat Baru Standar Terkait</b></small></label>
										<input type="hidden" id="jenis_dokumen_tambahan" name="jenis_dokumen_tambahan" value="5"/>
										<input type="text" class="form-control form-control-sm" id="kode_tambahan" name="kode_tambahan" placeholder="Silahkan diisi..."/>
									</div>
									<div class="form-group col-sm-4">
							...
							<div class="form-group col-sm-12">
								...
								<code><i><small>Jangan lupa P2M</small></i></code>
							</div>
							<hr>
	...
	$(function() {
		...
		$('#kode_no').select2({
			ajax: {
				...
				data: function (params) {return { search: params.term, page: params.page || 1, id_jenis:5, [csrfName]: csrfHash };},
