				...
				<form id="formValidate" class="formValidate">
					<div class="card shadow">
						<div class="card-header">
							<b>Tambah Dokumen Manual Mutu Penetapan</b>
						</div>
						<div class="card-body">
							...
							<div class="form-group col-sm-12">
								...
								<input type="text" class="form-control form-control-sm" value="MANUAL MUTU PENETAPAN" disabled/>
								<input type="hidden" id="jenis_dokumen" name="jenis_dokumen" value="2"/>
							</div>
							<div class="col-sm-12">
								<div class="row">
							...
							<div class="display_none col-sm-12" id="viewAddKode">
								<div class="row">
									<div class="form-group col-sm-8">
										...
										<input type="hidden" id="jenis_dokumen_tambahan" name="jenis_dokumen_tambahan" value="2"/>
	...
	$(function() {
		...
		$('#kode_no').select2({
			ajax: {
				...
				data: function (params) {return { search: params.term, page: params.page || 1, id_jenis:2, [csrfName]: csrfHash };},
