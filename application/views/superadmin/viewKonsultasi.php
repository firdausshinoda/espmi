		...
		<div class="col-sm-12 col-md-6">
			<div class="card shadow">
				<div class="card-body">
					...
					<hr>
					<button onclick="hapus('hapus-konsultasi','<?= $item->id_tb_konsultasi; ?>')" class="btn btn-danger btn-sm text-white float-right m-1"><i class="fa fa-trash-alt"></i> Hapus</button>
					<a href="<?= site_url('Superadmin/konsultasi?page=detail&id='.$item->id_tb_konsultasi); ?>" class="btn btn-success btn-sm text-white float-right m-1"><i class="fa fa-eye"></i> Lihat</a>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
