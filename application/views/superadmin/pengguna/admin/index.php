			...
			<div class="col-sm-12 mt-3">
				<div class="card card-white">
					<div class="card-header">
						<h3 class="card-title"><b>Pengguna Admin</b></h3>
					</div>
					<div class="card-body">
...
<a href="<?= site_url('Superadmin/pengguna?type=admin&page=new'); ?>" class="btn btn-primary btn-lg btn-floating shadow rounded-circle">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        dt = $("#dt_table").DataTable({
            "dom": 'Blfrtip',
            "buttons" : [
                { extend: 'csv', messageTop: 'Daftar Admin',
                    exportOptions: { columns: [ 0, 1, 2 ,3, 4, 5 ] },
                    title: 'Daftar Admin',
                },
                {
                    extend: 'excel', messageTop: 'Daftar Admin',
                    exportOptions: { columns: [ 0, 1, 2 ,3, 4, 5 ] },
                    title: 'Daftar Admin',
                },
                {
                    extend: 'pdf', messageTop: 'Daftar Admin', messageBottom: null,
                    exportOptions: { columns: [ 0, 1, 2 ,3, 4, 5 ] },
                    title: 'Daftar Admin',
                },
            ],
            ...
            "columns": [
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/pengguna?type=admin&page=detail&id=')?>'+row.id_tb_admin+'">'+row.nama_admin+'</a>';
                    }
                },
                {"data": "nipy"},
                {"data": "nama_unit"},
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/pengguna?type=admin&page=edit&id='); ?>'+row.id_tb_admin+'" class="btn btn-warning btn-sm btn-block shadow-sm">Edit</a>\n' +
