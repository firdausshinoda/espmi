			...
			<div class="col-sm-12 mt-3">
				<div class="card card-white">
					<div class="card-header">
						<h3 class="card-title"><b>Pengguna Biasa</b></h3>
					</div>
					<div class="card-body">
...
<a href="<?= site_url('Superadmin/pengguna?type=user&page=new'); ?>" class="btn btn-primary btn-lg btn-floating shadow rounded-circle">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        dt = $("#dt_table").DataTable({
            "dom": 'Blfrtip',
            "buttons" : [
                { extend: 'csv', messageTop: 'Daftar Pengguna Biasa',
                    exportOptions: { columns: [ 0, 1, 2 ] },
                    title: 'Daftar Pengguna Biasa',
                },
                {
                    extend: 'excel', messageTop: 'Daftar Pengguna Biasa',
                    exportOptions: { columns: [ 0, 1, 2 ] },
                    title: 'Daftar Pengguna Biasa',
                },
                {
                    extend: 'pdf', messageTop: 'Daftar Pengguna Biasa', messageBottom: null,
                    exportOptions: { columns: [ 0, 1, 2 ] },
                    title: 'Daftar Pengguna Biasa',
                },
            ],
            ...
            "columns": [
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/pengguna?type=user&page=detail&id=')?>'+row.id_tb_user+'">'+row.nama_user+'</a>';
                    }
                },
                {"data": "nipy"},
                {"render": function ( data, type, row ) {
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/pengguna?type=user&page=edit&id='); ?>'+row.id_tb_user+'" class="btn btn-warning btn-sm btn-block shadow-sm">Edit</a>\n' +
                            '<button type="button" class="btn btn-danger btn-sm btn-block shadow-sm" onclick="hapus(\'pengguna-user\',\''+row.id_tb_user+'\')">Hapus</button>';
                    }
                },
            ],
