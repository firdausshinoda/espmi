					...
					<div class="card card-white">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label for="nama"><small><b>Jenis Dokumen</b></small></label>
								<input type="text" class="form-control form-control-sm" id="jenis_dokumen" name="jenis_dokumen" placeholder="Silahkan diisi..."/>
							</div>
							<div class="form-group">
								<label for="keterangan"><small><b>Keterangan</b></small></label>
								<textarea class="form-control form-control-sm" id="keterangan" name="keterangan" placeholder="Silahkan diisi..." rows="4"></textarea>
							</div>
						</div>
                    ...
                    preConfirm: function () {
                        ...
                        return new Promise(function (resolve) {
                            $.ajax({
                                ...
                                url: "<?= site_url('Api/api_inputJenisDokumen'); ?>",
