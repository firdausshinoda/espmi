					...
					<div class="card card-white">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control form-control-sm" id="nomor_dokumen" name="nomor_dokumen" placeholder="Silahkan diisi..."/>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1"><small><b>Prihal Dokumen</b></small></label>
								<textarea class="form-control form-control-sm" id="perihal_dokumen" name="perihal_dokumen" placeholder="Silahkan diisi..." rows="7"></textarea>
							</div>
						</div>
                    ...
                    preConfirm: function () {
                        ...
                        return new Promise(function (resolve) {
                            $.ajax({
                                ...
                                url: "<?= base_url('Api/api_inputNoDok'); ?>",
