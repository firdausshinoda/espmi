...
<a href="<?= site_url('Superadmin/nodok?page=new'); ?>" class="btn btn-primary btn-lg btn-floating shadow rounded-circle">
        ...
        dt = $("#dt_table").DataTable({
            ...
            "columns": [
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/nodok?page=detail')?>'+"&id="+row.id_tb_dokumen_kode+'">'+row.nomor_dokumen+'</a>';
                    }
                },
                {"data": "jenis_dokumen"},
                ...
                {"render": function ( data, type, row ) {
                        return '<a href="<?= site_url('Superadmin/nodok?page=edit'); ?>'+"&id="+row.id_tb_dokumen_kode+'" class="btn btn-warning btn-sm btn-block shadow-sm">Edit</a>\n' +
                            '<button type="button" class="btn btn-danger btn-sm btn-block shadow-sm" onclick="hapus(\'nodok\',\''+row.id_tb_dokumen_kode+'\')">Hapus</button>';
                    }
                },
            ],
