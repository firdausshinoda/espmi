									...
									<div class="col-12">
										...
										<?php if ($detail->stt_dokumen == "MENUNGGU"):?>
											<div class="card-footer bg-white">
												<a href="<?= site_url('Superadmin/konsultasi?page=edit&id='.$detail->id_tb_konsultasi); ?>" class="btn btn-primary btn-sm float-right" style="color: #FFFFFF !important;">Ubah Data</a>
											</div>
										<?php endif; ?>
										<hr>
													...
													<li>
														...
														<div class="mailbox-attachment-info">
															...
															<span class="mailbox-attachment-size clearfix mt-1">
															  ...
															  <a href="<?= site_url('Superadmin/download?type=konsultasi&file='.$detail->file.'&nama='.$detail->nama_dokumen); ?>" class="btn btn-default btn-sm float-right"><i class="fas fa-cloud-download-alt"></i></a>
															</span>
															<?php if ($detail->stt_dokumen=="PUBLIS"):?>
																<button type="button" class="btn btn-danger btn-sm btn-block m-1" onclick="hapus('hapus-file-konsultasi','<?= $detail->id_tb_konsultasi ;?>','<?= $detail->file ;?>')">HAPUS FILE</button>
															<?php endif; ?>
														</div>
													</li>
												</ul>
...
<script type="text/javascript">
    ...
    function konfirm(id_konsultasi_unit_terkait) {
                ...
                return new Promise(function (resolve) {
                    $.ajax({
						...
						data: {
							...
							id_konsultasi_unit_terkait:id_konsultasi_unit_terkait,
							[csrfName]:csrfHash
						},
						dataType: 'json',
