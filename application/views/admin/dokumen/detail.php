					...
					<div class="card-body">
						...
						<div class="tab-content" id="custom-content-below-tabContent">
							<div class="tab-pane fade show active" id="custom-content-below-info" role="tabpanel" aria-labelledby="custom-content-below-info-tab">
								<div class="row">
									<div class="col-12">
										...
										<hr>
										<?php if (!empty($detail->file) && get('type')=="formulir" || !empty($detail->file) && get('type')=="manual-mutu-pelaksanaan"): ?>
													...
													<li>
														...
														<div class="mailbox-attachment-info">
															...
															<span class="mailbox-attachment-size clearfix mt-1">
															  ...
															  <a href="<?= site_url('Admin/download?type=dokumen&file='.$detail->file.'&nama='.$detail->nama_dokumen); ?>" class="btn btn-default btn-sm float-right"><i class="fas fa-cloud-download-alt"></i></a>
															</span>
														</div>
													</li>
												</ul>
							...
							<div class="tab-pane fade" id="custom-content-below-dokumen" role="tabpanel" aria-labelledby="custom-content-below-dokumen-tab">
								<div class="card mt-3">
									<div class="card-body">
										<?php if (get('type')=="formulir"||get('type')=="manual-mutu-pelaksanaan"):?>
