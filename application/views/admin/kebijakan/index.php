...
<?php if (set_btn_dokumen()):?>
	<a href="<?= site_url('Admin/kebijakan?page=new'); ?>" class="btn btn-primary btn-lg btn-floating shadow rounded-circle">
...
<script type="text/javascript">
    ...
    function getData() {
		$.ajax({
			type: "GET",
			data: {offset:start,search:$('#cari_dokumen').val(),kategori:"kebijakan"},
			url: "<?= site_url('Api/dokumenView?type=kebijakan'); ?>",
			beforeSend: function () {
