					...
					<div class="card shadow">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="add-controls" id="box_item">
									<div class="add-entry pt-1">
										<div class="row">
											<div class="col-sm-11">
												<select type="text" class="form-control form-control-sm select2" id="unit_terkait-1" name="unit_terkait[]" style="width: 100%"></select>
											</div>
											<div class="col-sm-1">
