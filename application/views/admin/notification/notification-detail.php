						...
						<div class="tab-content" id="custom-content-below-tabContent">
							<div class="tab-pane fade show active" id="custom-content-below-info" role="tabpanel" aria-labelledby="custom-content-below-info-tab">
								<div class="row mt-3">
									...
									<?php if ($stt_revisi && $detail->id_tb_unit == sess_get('id_unit')): ?>
										<div class="col-12">
											<hr>
													...
													<div class="card-body">
														<div class="row">
																...
																<div class="row">
																	<div class="col-sm-12 col-md-7">
																		<div class="form-group">
																			...
																			<input type="hidden" id="jenis_dokumen" name="jenis_dokumen" value="<?= $detail->jenis_dokumen?>">
															...
															<div class="col-sm-12">
																<hr>
																<div class="form-group">
																	<label><small>Keterangan Revisi</small></label>
																	<textarea class="form-control form-control-sm" id="keterangan_revisi" name="keterangan_revisi" rows="5" placeholder="Silahkan diisi..."></textarea>
																</div>
																<div class="form-group">
																	<label><small>Ditujukan Untuk Unit</small></label>
																	<select class="select2" multiple="multiple" name="unit_terkait[]" data-placeholder="Silahkan dipilih..." style="width: 100%;">
																		<?php foreach (db_view_unitTerkaitKonsultasi($detail->id_tb_konsultasi)->result() as $it_v): $no++;?>
																		<?php if ($it_v->stt_revisi_unit == "REVISI"):?>
																				<option value="<?= $it_v->nama_unit."/".$it_v->id_tb_unit;?>"><?= $it_v->nama_unit;?></option>
																		<?php endif; ?>
																		<?php endforeach; ?>
																	</select>
																</div>
											...
											<li>
												...
												<div class="mailbox-attachment-info">
													...
													<span class="mailbox-attachment-size clearfix mt-1">
														...
														<a href="<?= site_url('Admin/download?type=dokumen&file='.$detail->file.'&nama='.$detail->nama_dokumen.'&ext='.$detail->file_type); ?>" class="btn btn-default btn-sm float-right"><i class="fas fa-cloud-download-alt"></i></a>
													</span>
												</div>
											</li>
										</ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        dt = $("#dt_table").DataTable({
            ...
            "paging": true,
            "ajax": {
                "url": '<?= base_url('Api/api_getUnitTerkait');?>',
                "type": "POST",
                "data": function (d) {
        ...
        $('#formValidate').validate({
            rules: {
                nama_file:"required",size_file:"required",jml_halaman:{required:true, digits: true,},
				keterangan_revisi:"required","unit_terkait[]": "required"
            },
            messages: {
                nama_file:"Silahkan pilih file..",size_file:"Silahkan pilih file..",
                jml_halaman:{required:"Silahkan diisi..", digits: "Hanya boleh angka",},
				keterangan_revisi:"Silahkan diisi...","unit_terkait[]":"Silahkan dipilih...",
            },
			ignore: [],
                    ...
                    preConfirm: function () {
                        return new Promise(function (resolve) {
                            ...
                            $.ajax({
                                ...
                                url: "<?= site_url('Api/api_updateDokumenRevisi'); ?>",
            ...
            preConfirm: function () {
                return new Promise(function (resolve) {
                    $.ajax({
						...
						dataType: 'json',
                        url: "<?= base_url('Api/api_konfirmKonsultasi'); ?>",
                        success: function (data) {
                            $('#progress-upload').hide();
                            if (data.response.status==="OK"){
                                swalWithBootstrapButtons.fire({title: 'Berhasil.', text: "", icon: 'success',}).
