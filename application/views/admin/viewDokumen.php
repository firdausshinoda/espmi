		...
		<div class="col-sm-12 col-md-6">
			<div class="card shadow">
				<div class="card-body">
					...
					<hr>
					<a href="<?= site_url('Admin/dokumen?type='.$type.'&page=detail&id='.$item->id_tb_dokumen); ?>" class="btn btn-success btn-sm text-white float-right m-1"><i class="fa fa-eye"></i> Lihat</a>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
