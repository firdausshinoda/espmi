							...
							<div class="tab-pane fade show active" id="custom-content-below-info" role="tabpanel" aria-labelledby="custom-content-below-info-tab">
								<div class="row mt-3">
									<div class="col-12">
										...
										<div class="form-group">
											<?php if ($detail->id_tb_admin == sess_get('id')): ?>
												<?php if ($detail->stt_dokumen!="PUBLIS"):?>
													<a href="<?= site_url('Admin/konsultasi?page=edit&id='.$detail->id_tb_konsultasi); ?>" class="btn btn-warning btn-sm text-white float-right m-1"><i class="fa fa-pencil-alt"></i> Edit</a>
													<button class="btn btn-danger btn-sm text-white float-right m-1"><i class="fa fa-trash-alt"></i> Hapus</button>
												<?php endif; ?>
											<?php endif; ?>
										</div>
									</div>
	...
	$(document).ready(function() {
		...
		$('#formValidate').validate({
			...
			messages: {
				...
				keterangan_revisi:"Silahkan diisi..."
			},
			ignore: [],
