		...
		<div class="row p-3">
			<div class="col-sm-12 col-md-10 offset-md-1 mt-3">
				<div class="input-group input-group-sm">
					<input type="text" class="form-control" id="cari_dokumen" placeholder="Cari dokumen...">
					<span class="input-group-append">
                    <button type="button" class="btn btn-info btn-flat" onclick="cari()">Cari</button>
                  </span>
				</div>
			</div>
			<div class="col-sm-12 col-md-10 offset-md-1 mt-3" id="div_jenis">
...
<script type="text/javascript">
    ...
    function getData() {
		$.ajax({
			type: "GET",
			data: {offset:start,search:$('#cari_dokumen').val(),kategori:kat},
			url: "<?= base_url('Api/dokumenView'); ?>",
			beforeSend: function () {
